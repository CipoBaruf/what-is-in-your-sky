...
function DomeView(props: SkyChartProps) {
  ...
  return (
    <Suspense
      fallback={
        <ChartFrame controls={props.controls} status={<p className={styles.loading}>{t.chart.loadingDome}</p>} legend={props.legend} aside={props.aside} stripe={props.stripe} {...(props.box ? { box: props.box } : {})} fill={props.fill ?? false}>
...
function WindowView(props: SkyChartProps) {
  return (
    <Suspense
      fallback={
        <ChartFrame controls={props.controls} legend={props.legend} aside={props.aside} stripe={props.stripe} {...(props.box ? { box: props.box } : {})} fill={props.fill ?? false}>
