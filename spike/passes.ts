...
const NO_MOON = {
  moonAtPeak: { t: 0, phaseAngleDeg: 0, illuminatedFraction: 0, phase: 'new', azDeg: 0, elDeg: -30, eclipticLonDeg: 0 },
  moonGlare: { glare: false, separationDeg: 120 },
} satisfies Pick<Pass, 'moonAtPeak' | 'moonGlare'>;
