...
- [x] **R61 — The wide live page's rail: the rows go beside the dome, and the dome fills the width** *(added 2026-09-07 as a hotfix on the owner's ask, out of wave order; PLAN §16.9 gives it D-312..D-316.)*
  ...
  - **Done 2026-09-07:** as specified, with two decisions (D-312, D-313 — the second is the owner's inverse-scale ask on the deployed branch: the rail is capped at 60 cells, so it takes 33 % of the page at 1280 px and 15 % at 3840) and one recorded lane crossing (the `aside` slot in `chart`). Measured, box then drawing: 1280 × 800 → 798 × 680, 732 px (65 % → 92 % of the box's width); 1920 × 1080 → 1373 × 960, 1258 px (66 % → 92 %); 2560 × 1440 → 1924 × 1320, 1702 px (68 % → 88 %); 3840 × 2160 → 3204 × 2040, 2629 px (69 % → 82 %; above D-313's cap the box keeps the width the rail stops taking, and the drawing, height-bound by then, does not grow into it). The dome grows 10 to 17 % in absolute size at the same time. The tilt was measured and not taken (D-312 has the numbers). Captures: `docs/screenshots/r61-live-{1280,1920,2560}-dark-en.png` and `r61-live-1280-night-en.png`; the v1 set's live and legend captures at 1280 px re-shot, and R54's fold captures left as the record of the layout this replaces.
