...
- [x] **R76 — The first run: the cold open, the countdown, three readings, three panes** — done; the three-pane literal is 1118 px by F-10's rule (D-465), the input group is one instance across the cold open and the line so typing a place keeps its field (D-467), and the 1280 px assertions of `desktop.spec.ts` and `wide.spec.ts` follow the panes, with FR-DESK-2's two columns measured at 1024 px (D-469) (D-465..D-471).
  - **Lane:** ui
