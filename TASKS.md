...
- [x] **R94 — What a capture shows: `-view`, 360, 768, the home at 1920, the deterministic set** *(done: 254 files, not 241 — the `-view` twin follows the home at all six widths and the 768 column takes both live states; D-647)*
  - **Lane:** ui
  - **Model:** fable
  - **Gate:** auto
  - **Depends on:** R99, R85
