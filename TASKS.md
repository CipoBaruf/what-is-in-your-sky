...
- [ ] **R102 — The footer credits glyphcss and Juan Cruz Fortunatti**
  ...
  - **Goal:** the footer names the library the sky is drawn with and its author — "Sky chart: glyphcss by Juan Cruz Fortunatti." — with `glyphcss` linked to <https://glyphcss.com> and the name to <https://www.linkedin.com/in/juancfortunatti/>, in both languages and in every form the footer has.
