...
- AC4: The app can be installed: a manifest, an icon, and an install hint the browser's offer brings up. *(amended v1.1.2, V11-15; was "shown once")* Installing it answers the hint for good; "Not now" hides it for 7 days, a second "Not now" for 30 days, and a third never shows it again.
...
- The install offer stops being a one-shot latch: "Not now" snoozes it, 7 days then 30, and only the third decline is final (FR-OFF-6 as amended, V11-15).
...
- The amended FR-OFF-6 and US-16 AC4 are met: the snooze survives a reload, expires on its own, and the third decline is the latch.
