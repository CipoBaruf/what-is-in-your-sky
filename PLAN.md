...
| FR-DESK-1..4 | `ui/styles/global.css` + `ui/App.module.css` + `tests/styles` (D-71), `lib/layout.ts` + `ui/hooks/useLayoutMode.ts` (D-116), `ui/App.tsx`, `ui/components/guide/GuidePanel.tsx` (D-72, D-117, D-118), `lib/shortcuts.ts`, `ui/components/common/ShortcutsOverlay.tsx` (D-73) |
