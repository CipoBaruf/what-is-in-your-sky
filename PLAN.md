...
Recorded by the R1 implementation; the Heavens-Above comparison itself is still pending (no browser was available to transcribe the pass table by hand, and the fixture must not be scraped). Everything below is independent of that capture.
...
- **Window content:** with the 2026-09-02 elements, every ISS culmination above 10° at Neuquén in the ten days from 2026-09-02T03:27Z falls in daylight except one marginal twilight pass on 2026-09-11 09:48Z. A ten-day window with one pass is a weak validation; the README recommends capturing from about 2026-09-05 so the morning series that starts on 09-11 falls inside the window.
