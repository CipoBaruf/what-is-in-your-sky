...
│   │   └── styles/ tokens.css  global.css  theme.ts (the one writer of `data-theme`, D-95)
│   └── vite-env.d.ts
├── scripts/
...
| FR-THEME-1..3 | `ui/styles/tokens.css` `[data-theme="night"]` (D-84, D-96), `ui/styles/theme.ts` + `global.css` `html[data-theme]` (D-95), `main.tsx` (D-70), `ui/components/common/ThemeToggle.tsx`, `model/prefs.ts`, `scripts/contrast.ts`, `dome/palette.ts` |
